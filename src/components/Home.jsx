                ...
                {editingBirthday?._id === bday._id ? (
                  ...
                  <form onSubmit={(e) => handleEditSubmit(e, bday._id)}    className='w-full flex flex-col sm:flex-row gap-2'>
                    ...
                    <div className='flex gap-2 mt-2 sm:mt-0'>
                      <button type='submit'
                              disabled = {isEditing} 
                              className='bg-green-500 text-white px-3 py-1 rounded hover:bg-green-700 transition flex-1'>{isEditing ? 'Saving...' : 'Save'}</button>
                  ...
                  <div className='w-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2'>
                    ...
                    <div className='flex gap-2 mt-2 sm:mt-0 self-end sm:self-auto'>
                      ...
                      <button 
                        ...
                        className={`px-3 py-1 text-sm rounded ${deletingId === bday._id ? 'bg-gray-400 text-white cursor-not-allowed' : 'bg-red-500 hover:bg-red-600 text-white'}`}>
